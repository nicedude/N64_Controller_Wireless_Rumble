...
//uint8_t trigger_laststate;
//uint8_t reload_laststate;
//uint8_t both_laststate;

//unsigned char bullets_left = 10;

//unsigned long trigger_debounce_counter = 0;
//unsigned long reload_debounce_counter = 0;
